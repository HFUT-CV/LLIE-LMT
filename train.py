...
def main(gpu, args):
    ...
    trainer = Trainer(model=net, tmodel=ema_net, args=args, supervised_loader=paired_loader,
                      ...
                      val_loader=val_loader, iter_per_epoch=len(unpaired_loader), writer=writer, dataset_len=len(paired_dataset), undataset_len=len(unpaired_dataset), tmp_path=args.tmp_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_batchsize', default=2, type=int, help='train batchsize')
    ...
    parser.add_argument('--tmp_dir',
                        default='/home/a1005/Chinn/Kmeans_otherlabel/unlabeled/tmp_low/',
                        type=str, help='tmp data path')
